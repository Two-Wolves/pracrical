        ...
        foreach ($nav as $vo) {
            ...
            foreach ($first_menu as $vo_1) {
                if (auth($vo_1['href'])) {
                    ...
                    $menu_list['ytwlSystemForOa_' . $vo['id']][$i] = $vo_1;
                    ...
                    foreach ($second_menu as $vo_2) {
                        if (auth($vo_2['href'])) {
                            ...
                            $menu_list['ytwlSystemForOa_' . $vo['id']][$i]['children'][] = $vo_2;
                        }
                    }
                    //去除空菜单
                    if (!isset($menu_list['ytwlSystemForOa_' . $vo['id']][$i]['children'])) {
                        if ($menu_list['ytwlSystemForOa_' . $vo['id']][$i]['href'] == '#' || $menu_list['ytwlSystemForOa_' . $vo['id']][$i]['href'] == '') {
                            unset($menu_list['ytwlSystemForOa_' . $vo['id']][$i]);
                        } else {
                            $i++;
                        }
                    } else {
